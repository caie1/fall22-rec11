...
public class MemoryPlugin implements GamePlugin<Integer> {
    ...
    private static final List<String> WORDS = List.of("Apple", "Boat", "Car", "Dog", "Eagle", "Fish", "Giraffe",
            "Helicopter");
    ...
    public void onMovePlayed(int x, int y) {
        if (numberOfCardsSelected == 0) {
            if (firstIndexSelected >= 0 && secondIndexSelected >= 0) { // Avoids processing cards "selected" before
                                                                       // first turn
